...
public class DocumentsController : ClientControllerBase
{
    ...
    [HttpGet("/memberdocuments/{documentId}")]
    public async Task<JsonObject> GetDocument([FromRoute] string documentId)
    {
        ...
        using HttpResponseMessage response =
            await appClient.GetAsync($"app/memberdocuments/{documentId}");
    ...
    [HttpGet("/memberdocuments")]
    public async Task<JsonArray> ListDocuments()
    {
        var appClient = this.CcfClientManager.GetAppClient();
        using HttpResponseMessage response = await appClient.GetAsync($"app/memberdocuments");
        this.Response.CopyHeaders(response.Headers);
        await response.ValidateStatusCodeAsync(this.Logger);
    ...
    [HttpPut("/memberdocuments/{documentId}")]
    public async Task PutDocument([FromRoute] string documentId, [FromBody] JsonObject content)
    {
        var appClient = this.CcfClientManager.GetAppClient();
        using (HttpRequestMessage request = new(HttpMethod.Put, $"app/memberdocuments/{documentId}"))
        {
    ...
    [HttpPost("/memberdocuments/{documentId}/propose")]
    ...
    [HttpPost("/memberdocuments/{documentId}/vote_accept")]
    ...
    [HttpPost("/memberdocuments/{documentId}/vote_reject")]
    ...
    [HttpPost("/memberdocuments/{documentId}/vote")]
