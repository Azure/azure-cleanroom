...
mount_blobfuse_with_encryptor() {
  ...
  # Wait for daemon to come up and stabilize
  sleep 20
...
then
  ...
  # No need to generate bandwidth or latency related reports in this case
  executed=0
elif [[ ${test_name} == "app" ]]
then
...
then
  ...
  executed=0
  echo "Invalid argument. Please provide either 'read', 'write', 'highlyparallel', 'create', 'list', 'app' or 'rename' as argument"
fi
