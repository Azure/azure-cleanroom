...
@description('The managed identity ID to use for the deployment script')
...
@description('The name of the deployed release')
output releaseName string = releaseName

@description('The name of the chart')
output chartName string = chartName

@description('The namespace where the chart was deployed')
output namespace string = namespace

@description('The deployment script resource ID')
output deploymentScriptId string = helmInstallScript.id
